<!--
      Tony Pallone custom site,
      Feel free to use any code, I want my site to be able to be used for a lot and
      if you like the design enough that you would like to directly use it feel free
      please check my other work on my github

      Thanks to Sean Kirmani (https://github.com/kirmani), Nick Lambert (https://github.com/NicholasLambert) for teaching me
-->
